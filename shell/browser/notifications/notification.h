...
#ifndef CONTENT_SHELL_BROWSER_NOTIFICATIONS_BROWSER_NOTIFICATIONS_H_
#define CONTENT_SHELL_BROWSER_NOTIFICATIONS_BROWSER_NOTIFICATIONS_H_
...
class Notification {
  ...
  */
  ...
  const base::string16& display_source() const { return display_source_; }
   ...
   int notifier_id(){ return notifier_id_; }
...
#endif  // CONTENT_SHELL_BROWSER_NOTIFICATIONS_BROWSER_NOTIFICATIONS_H_